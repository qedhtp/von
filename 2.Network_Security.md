...
command:  
```bash
nmap -PE -sn 0.0.0.0/24 #-PE ICMP echo request
nmap -PP -sn 0.0.0.0/24 #-pp use ICMP timestamp request. if ICMP echo request be blocked  
...
nmap -sU 0.0.0.0/24 #UDP scan. no handhake 
